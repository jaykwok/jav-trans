...
- 1.7B CueQC v4 binary：用新 scorer/refiner workflow 跑 no-translate baseline，重新抽取候选与 ASR internals。聚类只做 cold-start 高精 seed；后续每轮按 false-drop/uncertainty/风险桶/随机混合抽约 200 条人工审计，再训练。匿名样片 B 保持最终测试片。
