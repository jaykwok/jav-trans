...
- real-domain forced-aligner silver 暂缓：旧 silver-ft01 已证明 forced-aligner 指标改善可能伴随人工观感和准确度下降。forced alignment 仅作为候选排序、诊断和审计信号，后续如作为 teacher 必须先经过人工过滤和单独 gate。
