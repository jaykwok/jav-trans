...
- 1.7B SpeechBoundary-JA scorer v4：按 2026-06-11/19 的 32768 hardmix 思路重建数据，监督 `speech`、`split_boundary`、`drop_gap` 三头。Galgame 随机拼接只表达“应切开”，不训练 speaker id；REAL-988 不进入训练或 pseudo pool。
