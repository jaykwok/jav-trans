...
- 1.7B CueQC v4 binary：等待 v4-native scorer 通过真实 workflow gate 后，重新用新 scorer/refiner 链路导出 candidates，再编译 v4 binary seed feature bundle 并训练首版 checkpoint。后续每轮按 false-drop/uncertainty/风险桶/随机混合抽约 200 条人工审计，再训练。REAL-988 保持最终测试片。
