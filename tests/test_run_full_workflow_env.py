...
def test_run_full_workflow_parse_args_uses_loaded_env(monkeypatch):
    ...
    monkeypatch.setenv("BOUNDARY_PLANNER_MAX_PADDED_CHUNK_S", "9.0")
    ...
    assert args.boundary_planner_max_padded_chunk_s == 9.0
...
def test_run_full_workflow_context_carries_boundary_env(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("BOUNDARY_PLANNER_MAX_PADDED_CHUNK_S", "9.5")
    ...
    assert ctx.advanced["BOUNDARY_PLANNER_MAX_PADDED_CHUNK_S"] == "9.5"
