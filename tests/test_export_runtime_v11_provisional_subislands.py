...
from tools.boundary.ja import export_runtime_v11_provisional_subislands as exporter
...
def test_binary_split_validation_accepts_outer_only_when_no_cut_event() -> None:
    chunk = SimpleNamespace(
        ...
        boundary_source="outer_edge_refiner_v2",
        boundary_decision_source="outer_edge_refiner_v2",
        semantic_event_ids=[],
