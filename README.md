...
- 当前研究方向：CueQC 已替代旧规则 ASR QC。后续优先做 Mamba2 frame scorer v2 的 NAMH-055 对比人工审计、更多全片人工抽检和离线 Boundary 反哺数据整理；forced aligner 暂保留为默认 word-timing polish、诊断和未来 teacher 信号。
