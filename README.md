...
- 默认不启用 speaker sidecar、人声聚类、Whisper/WhisperSeg/TEN/Silero/FSMN 或旧 FusionVAD 路线。
...
| Boundary Refiner | deterministic bootstrap 或 `src/boundary/checkpoints/boundary_refiner.pt` | `src/boundary/checkpoints/boundary_refiner.pt` |
