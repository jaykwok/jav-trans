...
def _quality_report_markdown(video_stem: str, report: dict) -> str:
    metric_keys = [
        ...
        "vocalisation_acoustics_available",
        "vocalisation_cues_dropped_by_acoustics",
        "vocalisation_cues_marked",
        "vocalisation_mixed_cues_detected",
        "vocalisation_mixed_cues_split",
        "vocalisation_split_removed_seconds",
        "vocalisation_split_removed_chars",
