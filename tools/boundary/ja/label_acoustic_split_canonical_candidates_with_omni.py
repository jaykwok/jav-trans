...
from tools.boundary.ja.acoustic_split_teacher_contracts import (  # noqa: E402
    ACOUSTIC_SPLIT_TEACHER_LABEL_SCHEMA as LABEL_SCHEMA,
    ACOUSTIC_SPLIT_TEACHER_PROMPT_VERSION as PROMPT_VERSION,
    ACOUSTIC_SPLIT_TEACHER_RETRY_SCHEMA,
...
def prepare_hard_cases(args: argparse.Namespace) -> list[dict[str, Any]]:
    ...
    if args.heldout_source_audio:
        ...
        clip_path = output_dir / "request_audio" / "匿名样片 C-known-same-sentence.wav"
        slice_audio_clip(
        ...
        heldout = {
            "schema": SELECTION_SCHEMA,
            "window_id": "匿名样片 C-known-same-sentence-23.538",
            "partition": "heldout",
            "trainable": False,
            "audio_path": str(clip_path),
            "duration_s": 8.0,
            "source_video_id": "匿名样片 C",
...
def run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if args.prepare_only:
        summary = {
            "schema": ACOUSTIC_SPLIT_TEACHER_SUMMARY_SCHEMA,
            "prepared_only": True,
    ...
    for row in existing_rows:
        if (
            ...
            raise RuntimeError(
                "existing canonical Split labels use a different schema/model/prompt/thinking/"
    ...
    for item in selected:
        ...
        for candidate in item["candidates"]:
            ...
            try:
                ...
                failures.append(
                    {
                        "schema": ACOUSTIC_SPLIT_TEACHER_RETRY_SCHEMA,
                        "window_id": window_id,
                        "feature_index": feature_index,
                        "time_s": time_s,
                        "error": repr(exc),
