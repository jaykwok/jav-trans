...
def build_page(*, rows: list[dict[str, Any]], output_dir: Path, update_latest: bool = True) -> Path:
    ...
    html = f"""<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><title>Inner sub-island edge audit</title><style>
