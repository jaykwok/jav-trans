...
from boundary.ja import LabelRecord, read_jsonl, write_jsonl
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Combine SpeechBoundary-JA label JSONL files and audio manifests.")
    ...
    parser.add_argument("--output-dir", default=str(PROJECT_ROOT / "agents" / "temp" / "speech-boundary-ja" / "combined"))
