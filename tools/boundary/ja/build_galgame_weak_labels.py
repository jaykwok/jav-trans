...
from boundary.ja import build_weak_positive_record, write_jsonl
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build Galgame weak-positive SpeechBoundary-JA labels from materialized HF audio.")
    ...
    parser.add_argument("--output-dir", default=str(PROJECT_ROOT / "agents" / "temp" / "speech-boundary-ja" / "galgame-weak-labels"))
