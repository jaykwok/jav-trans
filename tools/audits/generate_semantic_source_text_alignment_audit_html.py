...
<div class="step"><h3>3 · membership envelope</h3><p>蓝色 membership span <b>不是 Omni 的额外判断</b>，而是由全部 matched 绿色 semantic spans 的最早 start 到最晚 end 确定性派生。它只允许桥接语义区间之间的内部空洞，绝不向两侧吸收亲吻声、喘息、呻吟、尾音、BGM、环境噪声或背景人声。</p></div>
...
function approved(a){{return a.text_verdict==='approve'&&a.timeline_verdict==='approve'&&a.membership_verdict==='approve';}}
