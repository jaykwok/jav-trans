...
from vad.fusionvad_ja import build_negative_record, write_jsonl
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build deterministic synthetic negative labels for FusionVAD-JA smoke tests.")
    ...
    parser.add_argument("--output-dir", default=str(PROJECT_ROOT / "agents" / "temp" / "fusionvad-ja" / "synthetic-negatives"))
