...
from vad.fusionvad_ja import sample_hf_audio_16k_mono, stable_hf_audio_id
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Materialize HF audio samples to local wav files for FusionVAD-JA research.")
    ...
    parser.add_argument("--output-dir", default=str(PROJECT_ROOT / "agents" / "temp" / "fusionvad-ja" / "hf-audio"))
