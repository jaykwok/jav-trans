...
def _cueqc_from_decisions(
    ...
    *,
    ...
    return {
        ...
        "stage_cueqc_shadow_drop_count": stage_timings.get("cueqc_drop_count"),
        "mode": dict(modes),
        "display_hint": dict(display),
        "fallback_stage": dict(fallback_stage),
        "fallback_reason": dict(fallback_reason),
...
def main(argv: list[str] | None = None) -> int:
    ...
    markdown = [
        ...
        f"- CueQC shadow model/drop/fallback: `{cueqc_summary['model_count']}/{cueqc_summary['drop_count']}/{cueqc_summary['fallback_count']}`",
        f"- CueQC shadow stage_drop_count: `{cueqc_summary.get('stage_cueqc_shadow_drop_count', '')}`",
