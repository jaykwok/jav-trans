...
- 逐句报告产物默认写入 `reports/`；历史 匿名样片 K 报告包含 `sample-k_sentence_report.html`、`sample-k_sentence_report.md`、`sample-k_sentence_diffs_only.md`、`sample-k_sentence_report.csv`、`sample-k_sentence_report_summary.json`。
